...
export default function Asistente() {
  ...
  async function send(msg) {
    ...
    setLoading(true)
    const sys = 'Eres el asistente de Parquet Home, empresa de parquet y puertas en Barcelona. Hablas en español. Stock actual: ' + (context?.productos.map(p => p.nombre + ': ' + p.stock + ' ' + p.unidad + ' (min:' + p.min + ')').join(', ') || 'sin datos')
    try {
